...
const buttons: { title: string, route: string, svg: React.ReactElement<SVGElement> }[] = [
  ...
  { title: 'Projects', route: '/admin/projects', svg: (<svg xmlns="http://www.w3.org/2000/svg" height="4em" viewBox="0 0 384 512"><path d="M0 64C0 28.7 28.7 0 64 0L224 0l0 128c0 17.7 14.3 32 32 32l128 0 0 288c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64zm384 64l-128 0L256 0 384 128z"/></svg> )},
];
...
const Admin: React.FC<any> = (props: any) => {
  ...
  return (
    <div className='py-16'>
      ...
      <h1 className="text-xl text-white text-center align-middle inline-block ml-2 md:ml-8 mt-16">
        &nbsp;&nbsp;Admin&nbsp;&nbsp;
      </h1>

      <div className="text-center p-1 m-1 md:p-8 md:m-8 bg-gradient-to-br from-slate-100 via-slate-200 to-slate-400">
        <div className='p-4 md:p-8 m-1 rounded-lg bg-gradient-to-br from-slate-100 via-slate-200 to-slate-400'>
      ...
      <div className='bg-gradient-to-br from-slate-100 via-slate-200 to-slate-400 bg-opacity-90 text-center rounded-lg p-1 m-1  md:p-8 md:m-8'>
